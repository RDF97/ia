...
/**
 * Botón flotante redondeado con "+" — como el .fab del mockup.
 * Va dentro de `Screen floating`. Todo el estilo en un View normal con estilo
 * fijo (misma estructura que AddBar, que es la que renderiza bien).
 */
export function AddFab({ onPress, icon = "add" }: { onPress: () => void; icon?: IoniconName }) {
  const t = useTheme();
  return (
    <View
      style={{
